/* D3 Line Chart */
/// these things do not depend on the data
...
d3.csv('long-term-interest-monthly.csv').then(data => {
    ...
    let x = d3.scaleTime()  //d3 scale time function
        .domain(d3.extent(data, d => d.Date)) //extent gets space it takes out from date - it's an array
